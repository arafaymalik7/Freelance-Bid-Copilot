...
const CLASSIFICATION_SCHEMA = {
  ...
  required: ["category", "confidence", "reasoning", "typical_stack", "pricing_unit"],
  properties: {
...
confidence, reasoning, likely stack, and best pricing unit.`;
...
module.exports = { classifyProject, validateClassification, CATEGORIES };
